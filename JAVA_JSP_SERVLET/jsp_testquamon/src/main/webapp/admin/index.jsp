			  			...
			  			<div class="row">
				            <div class="col-md-4 col-sm-4 col-xs-4">
				                <div class="panel panel-back noti-box">
				                    ...
				                    <div class="text-box">
				                        <p class="main-text"><a class="fs-14" href="<%=request.getContextPath()%>/admin/cat.jsp" title="">Quản lý danh mục BDS</a></p>
				            ...
				            <div class="col-md-4 col-sm-4 col-xs-4">
				                <div class="panel panel-back noti-box">
				                    ...
				                    <div class="text-box">
				                        <p class="main-text"><a class="fs-14" href="<%=request.getContextPath()%>/admin/news.jsp" title="">Quản lý BDS</a></p>
				                        <p class="text-muted">Có 20 BDS</p>
				                    </div>
				                </div>
				            </div>
				            <div class="col-md-4 col-sm-4 col-xs-4">
