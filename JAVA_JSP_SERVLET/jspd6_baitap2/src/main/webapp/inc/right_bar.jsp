...
<div class="col-md-4 content-main-right">
				 ...
				 <div class="categories">
					 ...
					 <li class="active"><a href="danh-muc.jsp">Bạn quen thời phổ thông</a></li>
					 <li><a href="danh-muc.jsp">Bạn quen thời đại học</a></li>
					 <li><a href="danh-muc.jsp">Bạn tâm giao</a></li>
				 </div>
				 
				 <div class="categories">
					 <h3>Video hành trình</h3>
					 <li class="active"><a href="danh-muc.jsp">Hành trình đèo Hải Vân</a></li>
					 <li><a href="danh-muc.jsp">Chinh phục đỉnh Fansipan</a></li>
					 <li><a href="danh-muc.jsp">Vượt thác Thủy Điện</a></li>
				 </div>
