                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            if("3".equals(error)){
                            	...
                            	out.print("<p style=\"color: red;\">Không tìm thấy ID.</p>");
                            }
                                		...
                                		for(Categories objCat : items){
                                			...
                                			<tr>
                                        		...
                                        		<td class="center"><%=objCat.getCatName()%></td>  
                                        		 <%if("admin".equals(userLogin.getUsername())){ %>                                      
                                        		<td class="center">
                                            	<a href="<%=request.getContextPath()%>/admin/cats/edit?id=<%=objCat.getIdCat()%>" title="" class="btn btn-primary"><i class="fa fa-edit "></i> Sửa</a>
...
<script>
	function showMess(id) {
		...
		if(option){
			location.href = "<%=request.getContextPath()%>/admin/cats/del?id="+id;
		}
	}
</script>
<script>
