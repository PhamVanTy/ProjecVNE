                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6" style="text-align: right;">
                                    <form method="post" action="">
                                        ...
                                        <input type="search" class="form-control input-sm" placeholder="Nhập tên user" style="float:right; width: 300px;" />
                               ...
                               if(listUser != null || listUser.size() > 0){ 
                            	   for(Users objU : listUser){ %>
                                			...
                                			<tr>
                                        		...
                                        		<%if("admin".equals(userLogin.getUsername())){ %>                                     
                                        		<td class="center">
	                                            	<a href="<%=request.getContextPath()%>/admin/users/edit?id=<%=objU.getId_user()%>" title="" class="btn btn-primary"><i class="fa fa-edit "></i> Sửa</a>
...
<script>
	function showMess(id) {
		...
		if(option){
			location.href = "<%=request.getContextPath()%>/admin/users/del?id="+id;
		}
	}
</script>
<script>
