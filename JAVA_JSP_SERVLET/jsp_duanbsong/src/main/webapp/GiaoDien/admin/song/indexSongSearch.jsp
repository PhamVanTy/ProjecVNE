                                ...
                                <%
                                	...
                                	if(listSong != null && listSong.size() > 0){
                                		...
                                		<tr>
	                                        ...
	                                        <%if("admin".equals(userLogin.getUsername())){ %> 
	                                        <td class="center">
	                                            <a href="<%=request.getContextPath()%>/admin/songs/edit?id=<%=objSong.getIdSong()%>" title="" class="btn btn-primary"><i class="fa fa-edit "></i> Sửa</a>
...
<script>
	function showMess(id) {
		...
		if(option){
			location.href = "<%=request.getContextPath()%>/admin/songs/del?id="+id;
		}
	}
</script>
<script>
